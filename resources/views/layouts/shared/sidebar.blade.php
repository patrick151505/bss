        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item {{ request()->routeIs('dashboard.activity') ? 'active' : '' }}">
                <a href="{{ route('dashboard.activity') }}" class="menu-link">
                    ...
                    <span class="menu-text">Activity Dashboard</span>
                </a>
            </li>
            ...
            <li class="menu-item {{ $citizenGroupActive ? 'active open' : '' }}">
                ...
                <ul class="sub-menu {{ $citizenGroupActive ? '' : 'hidden' }}">
                    <li class="menu-item {{ request()->routeIs('citizens.*') && !request()->routeIs('citizens.ids.*') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->routeIs('documents.requests.*') || request()->routeIs('documents.types.*') ? 'active open' : '' }}">
                <a href="javascript:void(0)" data-fc-type="collapse" class="menu-link">
                    <span class="menu-icon"><i class="mgc_document_2_line"></i></span>
                    <span class="menu-text">Documents</span>
                    <span class="menu-arrow"></span>
                </a>
                <ul class="sub-menu {{ request()->routeIs('documents.requests.*') || request()->routeIs('documents.types.*') ? '' : 'hidden' }}">
